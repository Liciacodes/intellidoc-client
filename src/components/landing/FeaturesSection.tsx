...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gray-100 dark:bg-gray-900/50" id="features">
      <div className="container mx-auto px-4 lg:px-10">
        <div className="flex flex-col gap-12">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4 text-lg max-w-3xl mx-auto">
...
const FeatureCard: React.FC<{ icon: string; title: string; description: string }> = ({ 
  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-background-light dark:bg-background-dark p-6 text-center items-center">
      ...
      <h3 className="text-gray-900 dark:text-white text-xl font-bold leading-tight">{title}</h3>
