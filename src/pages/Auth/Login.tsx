      ...
      <div className="relative bg-white dark:bg-[#1c2127] px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-xl sm:px-10">
        <div className="mx-auto max-w-md">
          ...
          <div className="flex items-center gap-2 mb-8 justify-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">IntelliDoc</h1>
          </div>
            ...
            <div className="space-y-6 py-8 text-base leading-7 text-gray-600 dark:text-gray-400">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <label className="flex flex-col">
                  <p className="text-gray-900 dark:text-white text-sm font-medium leading-normal pb-2">Email Address</p>
                  <input
                    name="email"
                    type="email"
                ...
                {/* Password field */}
                <label className="flex flex-col">
                  <p className="text-gray-900 dark:text-white text-sm font-medium leading-normal pb-2">Password</p>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex w-full justify-center items-center rounded-lg bg-primary px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary disabled:opacity-50"
                >
                  {loading ? (
                    <>
                      <svg
              ...
              <div className="relative flex items-center py-2">
                ...
                <span className="mx-4 text-sm text-gray-400 dark:text-gray-500">Or continue with</span>
                <div className="grow border-t border-gray-300 dark:border-gray-700"></div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <button className="flex items-center justify-center gap-2 w-full rounded-lg h-12 px-5 bg-white dark:bg-[#2a3038] text-gray-800 dark:text-white border border-gray-300 dark:border-[#3b4754] hover:bg-gray-100 dark:hover:bg-[#3b4754] transition-colors">
                  <img src="https://www.svgrepo.com/show/475661/microsoft.svg" alt="Microsoft" className="w-5 h-5" />
