  ...
  return (
    <div className="flex-1 overflow-y-auto bg-dashboard-secondary dark:bg-[#111418]/50 font-display">
      <div className="w-full">
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap justify-between items-start gap-3 md:gap-4 mb-6 md:mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {tools.map((tool) => (
            <div
              key={tool.name}
              className="flex flex-col items-center justify-center text-center p-5 md:p-6 bg-dashboard-bg-light dark:bg-dashboard-sidebar-dark rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer"
            >
              {/* Icon */}
              <div className={`${tool.bgColor} p-2.5 md:p-3 rounded-lg mb-3 md:mb-4`}>
                <span
                  className={`material-symbols-outlined ${tool.iconColor} text-2xl md:text-3xl`}
                >
                  {tool.icon}
                </span>
              </div>
              ...
              {/* Tool Name */}
              <p className="text-dashboard-text-light dark:text-dashboard-text-dark text-sm md:text-base font-semibold mb-1 md:mb-2">
                {tool.name}
              </p>
              
              {/* Tool Description */}
              <p className="text-dashboard-text-secondary-light dark:text-dashboard-text-secondary-dark text-xs md:text-sm leading-relaxed">
                {tool.description}
              </p>
            </div>
          ))}
